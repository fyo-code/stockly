# Iteration 5D — V2 BF-Aware Feature Matrix Audit

## Phase 6 Additions

- Added leak-safe BF calendar features: pre-BF, BF, post-BF target flags; days from BF start/end; BF/pre-BF/post-BF horizon overlap days.
- Added BF-contaminated-history features: BF units, BF transaction share, raw non-BF recent units, 4-week-equivalent non-BF recent units, last-4-week BF unit share, and post-BF contamination ratios.
- Snapshot count stayed stable at 30,891 headline SKU-window rows. Numeric feature count increased from 66 to 90.
